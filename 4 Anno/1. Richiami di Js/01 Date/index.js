...
window.onload= function(){
	...
	//Gestione data 2 
	dataCorrente = eliminaOffset(dataCorrente)
	...
	button.addEventListener("click", function(){		
		...
		let diff = data2.getTime() - data1.getTime() //La funzione getTime() non è obbligatoria ma più leggibile
		//Get time restituisce i millisecondi di Greenwich non quelli del fuso orario locale
	...
	function eliminaOffset(dataCorrente)
	{
		//Offset è espresso in minuti
		const OFFSET = dataCorrente.getTimezoneOffset()
		dataCorrente = dataCorrente.getTime() - (OFFSET * 60 * 1000)
