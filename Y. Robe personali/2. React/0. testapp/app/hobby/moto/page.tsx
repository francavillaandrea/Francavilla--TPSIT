...
export default function MotoPage() {
    return (
        <SiteLayout current="hobby" currentHobby="moto" title="Moto: tecnica e passione" eyebrow="Hobby" subtitle="Dal primo enduro alla manutenzione pratica: il lato più tecnico delle mie passioni.">
            <div className="card section-card mb-4">
                ...
                <div className="card-body">
                    ...
                    <p className="mb-0 text-muted">
                        La Beta RR 50 è stata la mia prima moto: leggera, affidabile e perfetta per entrare nel mondo enduro.
            ...
            <div className="row g-3 mb-4">
                <div className="col-12 col-md-4">
                    <img src="/assets/img/Beta3.jpg" className="img-fluid rounded cover-small w-100" alt="Beta vista laterale" />
                </div>
                <div className="col-12 col-md-4">
                    <img src="/assets/img/Beta4.jpg" className="img-fluid rounded cover-small w-100" alt="Beta dettaglio" />
                </div>
                <div className="col-12 col-md-4">
                    <img src="/assets/img/Beta5.jpg" className="img-fluid rounded cover-small w-100" alt="Beta posteriore" />
                </div>
            </div>
            ...
            <div className="card section-card mb-4">
                <div className="card-body">
                    ...
                    <p className="text-muted mb-3">
                        Dalla prima guida a 15 anni, la moto è diventata uno spazio di apprendimento pratico: attenzione ai dettagli,
                        gestione degli imprevisti e capacità di migliorare costantemente.
                    </p>
                    <p className="text-muted mb-0">
                        Anche la componente familiare è importante: la passione condivisa con mio padre mi ha trasmesso cultura tecnica
            ...
            <div className="card section-card">
                <div className="card-body">
                    ...
                    <div className="row g-4">
                        ...
                        <div className="col-12 col-lg-6">
                            <img src="/assets/img/Freccia.jpg" className="img-fluid rounded cover-medium w-100" alt="Cagiva Freccia C12R" />
